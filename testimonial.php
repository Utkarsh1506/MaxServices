    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                <h1 class="fw-bold text-primary text-uppercase">Winner 2022 India SME 100 Awards</h1>
                <p class="mb-0">Mr. Rajesh Kumar Singh, MD of Megamax Services Pvt. Ltd. receives the Winner Trophy at the 9th Edition of India SME 100 Awards 2022 at the hands of Shri</p>
                <p>Bhanu Pratap Singh Verma Ji, Hon’ble MOS, MSME and Shri B B Swain, IAS, Secretary Ministry of MSMEs, on 13th April 2022.
            ...
            <div class="row g-5">
                <div class="col-lg-8">
                    ...
                    <!-- Blog Detail Start -->
                    <div class="mb-5">
                        <img class="img-fluid w-100 rounded mb-5" src="img/award.png" alt="">
                ...
                <div class="col-lg-8">
                    <div class="row g-5">
                            ...
                            <div class="blog-item bg-light rounded overflow-hidden">
                                ...
                                <div class="p-4">
                                    <div class="d-flex mb-3">
                                        ...
                                        <small><i class="far fa-calendar-alt text-primary me-2"></i>16 March, 2024</small>
                                    </div>
                                    <!--h4 class="mb-3">How to build a website</h4-->
                                    <p>Megamax Services Badminton Tournament 2022.</p>
                            ...
                            <div class="blog-item bg-light rounded overflow-hidden">
                                ...
                                <div class="p-4">
                                    <div class="d-flex mb-3">
                                        ...
                                        <small><i class="far fa-calendar-alt text-primary me-2"></i>31 Jan, 2025</small>
                                    </div>
                                    
                                    <p>A Team of World-Class Mavens Catering to End-to-End Enterprise Requirements.</p>
                            ...
                            <div class="blog-item bg-light rounded overflow-hidden">
                                ...
                                <div class="p-4">
                                    <div class="d-flex mb-3">
                                        ...
                                        <small><i class="far fa-calendar-alt text-primary me-2"></i>31 Jan, 2024</small>
                                    </div>
                                    
                                    <p>Levearing News & Inovtaion technologies To cater To End-to-End Enterprise Requirements.</p>
                        ...
                        <!--div class="col-md-6 wow slideInUp" data-wow-delay="0.6s">
                            <div class="blog-item bg-light rounded overflow-hidden">
                                <div class="blog-img position-relative overflow-hidden">
                                    <img class="img-fluid" src="img/Blog 4.png" alt="">
                                    
                                </div>
                                <div class="p-4">
                                    <div class="d-flex mb-3">
                                        
                                        <small><i class="far fa-calendar-alt text-primary me-2"></i>24 Jan, 2024</small>
                                    </div>
                                    
                                    <p>Megamax Services contributed to insightful dialogue hosted by NASSCOM and MPSEDC</p>
